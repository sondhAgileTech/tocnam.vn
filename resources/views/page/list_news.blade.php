...
@section('content')
    ...
    <div class="elle-breadcrumb-wrapper gray-background">
        <div class="container">
            <div class="breadcrumb elle-breadcrumb">
                <span xmlns:v="http://rdf.data-vocabulary.org/#"><span typeof="v:Breadcrumb"><a href="{{''}}" rel="v:url" property="v:title">Trang chủ</a> /
                        <span class="breadcrumb_last">{{$data['title_seo_relate']->name}} </span></span></span></div>
        </div>
    </div>
    <!-- Content -->
    @if($data)
        <div class="main-content">
            <div class="container">
                ...
                <a href="javascript:void(0)" title="" class="readmore-category btn-viewmore" term-id="{{$data['title_seo_relate']->slugs}}" data-page="1" type-news="news" number-post-page-first="20" posts-per-page="10" >Xem thêm...</a>
